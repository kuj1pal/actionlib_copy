...
if(FALSE)
  set(actionlib_SOURCE_PREFIX /tmp/buildd/ros-groovy-actionlib-1.9.11-0precise-20130325-2034)
  set(actionlib_DEVEL_PREFIX /tmp/buildd/ros-groovy-actionlib-1.9.11-0precise-20130325-2034/obj-x86_64-linux-gnu/devel)
  ...
  set(actionlib_INSTALL_PREFIX /opt/ros/groovy)
...
if(NOT "/opt/ros/groovy/include;/usr/include" STREQUAL "")
  set(actionlib_INCLUDE_DIRS "")
  set(absolute_include_dirs "/opt/ros/groovy/include;/usr/include")
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /opt/ros/groovy/${idir})
      ...
      message(FATAL_ERROR "Project 'actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/groovy/${idir}'.  Ask the maintainer 'Eitan Marder-Eppstein <eitan@willowgarage.com>' to fix it.")
    endif()
